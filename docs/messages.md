# Messages
The EINR protocol specifies a set of [messages](https://en.bitcoin.it/wiki/Protocol_specification) that can be sent from peer to peer. `einrcore-p2p` provides support for some of these messages.
